...
export const Input = ({type, label, placeholder, classnames = '', onChange, capture, required, error, disabled }: Properties) => {
  const inputClasses = useMemo(() =>
    error ? `${styles.inputError} ${styles.input} ${classnames}` : `${styles.input} ${classnames}`, [error]
  );
